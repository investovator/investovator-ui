 ...
 * @version: ${Revision}
 */
public class NNUIUpdater {

    private ArrayList<GameEventListener> listeners;
    private UserData userData;

    private static NNUIUpdater instance;
    ...
    public static NNUIUpdater getInstance() {
        if (instance == null) {
            synchronized (NNUIUpdater.class) {
                if (instance == null)
                    instance = new NNUIUpdater();
            }
        }
        return instance;
    }
