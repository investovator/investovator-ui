 ...
 * @version: ${Revision}
 */
public class MasterDetailChart {

    @SuppressWarnings("deprecation")
    private static final Date DEMO_DATA_INITIAL_DETAIL_START = new Date(
            2010 - 2008, 7, 1);
    @SuppressWarnings("deprecation")
    private static final Date DEMO_DATASET_END = new Date(2010 - 2008, 0, 1);
    @SuppressWarnings("deprecation")
    private static final Date DEMO_DATASET_START = new Date(2012 - 2008, 0, 1);
    ...
    protected Component getChart() {
        ...
        masterChart.addChartSelectionListener(new ChartSelectionListener() {
            ...
            public void onSelection(ChartSelectionEvent event) {
                ...
                List list = getPartialList(start, end);
    ...
    private List getPartialList(long start, long end) {
    ...
    private Number[] getInitialDetailData() {
        return (Number[]) getPartialList(DEMO_DATA_INITIAL_DETAIL_START.getTime(),
    ...
    private Chart getDetailChart() {
        ...
        two.setPlotOptions(plotOptionsArea);
        two.setData(getInitialDetailData());
        configuration.getLegend().setEnabled(false);
        configuration.setExporting(false);
        configuration.addSeries(seriesList);
        configuration.addSeries(two);
